            ...
            <div class="card-body" :style="{ height: height + 'px' }">
                <div class="row mb-3">
                    <div class="col-xl-6 col-sm-6 form-inline">
                        <button @click="add" type="button" class="btn btn-danger waves-effect waves-light mr-2"><i class='bx bx-plus-medical'></i></button>
                ...
                <div class="modal fade exampleModal" id="new" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <school-create @status="message" :gradings="gradings" :terms="terms" :klases="klases" ref="create"></school-create>
                </div>
...
export default {
    ...
    methods: {
        ...
        fetch(page_url) {
            ...
            page_url = page_url || this.currentUrl + '/request/schools/'+key+'/'+this.counts;
