                                ...
                                <div class="col-md-4">
                                    <div class="form-group" style="margin-top: 10px;">         
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" v-model="is_jlss" class="custom-control-input" id="formrow-jlss">
                                            <label class="custom-control-label font-size-12" for="formrow-jlss">Is JLSS School?</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group" style="margin-top: 10px;">         
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" v-model="is_undergrad" class="custom-control-input" id="formrow-undergrad">
                                            <label class="custom-control-label font-size-12" for="formrow-undergrad">Is Undergrad School?</label>
                                        </div>
                                    </div>
                                </div>             
