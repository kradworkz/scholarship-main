        ...
        <table class="table table-centered table-nowrap">
            ...
            <tbody>
                <tr v-for="list in lists" v-bind:key="list.id">
                    ...
                    <td class="text-center">{{list.region_code}}</td>
                </tr>
            </tbody>
        </table>
    </div>
    ...
    export default {
        ...
        methods : {
            ...
            fetch(page_url){
                ...
                page_url = page_url || this.currentUrl + '/request/location/provinces/'+this.counts+'/'+key;
                axios.get(page_url)
                .then(response => {
            ...
            sync(){
                this.isLoading = true;
                axios.get(this.currentUrl + '/request/provinces/fetch')
                .then(response => {
                    this.locations = response.data;
                    this.$refs.sync.set(this.locations,'provinces');
